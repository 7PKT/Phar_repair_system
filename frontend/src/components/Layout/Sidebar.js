...
const Sidebar = () => {
  ...
  const isCurrentPath = (path) => {
    // แยกการตรวจสอบแต่ละ path ให้แม่นยำ
    switch (path) {
      case '/dashboard':
      ...
      case '/repairs':
        // ตรวจสอบว่าเป็น /repairs แต่ไม่ใช่ /repairs/new หรือ /repairs/edit หรือ /repairs/:id
  ...
  // เพิ่มฟังก์ชันตรวจสอบว่าเป็น repair-related page หรือไม่
        ...
        <div className="space-y-1">
          {navigationItems
            ...
            .map((item) => {
              ...
              // กรณีพิเศษ: ถ้าเป็นหน้า repair detail/edit ให้ไฮไลท์ที่ "รายการแจ้งซ่อม"
